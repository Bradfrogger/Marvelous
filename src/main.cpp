...
#if defined(NDEBUG)
# error "Marvelous cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x6e01f4777a2d572e4ef2da642aeaf4b71e28a80ccd322f5df1256e8f5f39b1ff");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Marvelous: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Marvelous Signed Message:\n";
...
{
    // Marvelous: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Marvelous: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Marvelous: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1466723405, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fb1fa01b6c22be89f68e8ad3cabdee45f6d138c50504c93fff8597c6e87e04b6812e9123ed624b68a6301dc3c9520d40881b950608dd82d6b9aace5491b3a661") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1466723405;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2373383;
        ...
        assert(block.hashMerkleRoot == uint256("0x47fbe7ce4c73a1ed46e47f1021f80000765529178cfe5934c0480c031f28a0e8"));
...
unsigned char pchMessageStart[4] = { 0x6e, 0xf8, 0xf5, 0x09 }; // Marvelous: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MarvelousMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MarvelousMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static MarvelousMiner(CWallet *pwallet)
{
    printf("MarvelousMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("marvelous-miner");
    ...
    try { loop {
        ...
        printf("Running MarvelousMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MarvelousMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MarvelousMiner, pwallet));
}
